  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button className="bg-orange-400 hover:bg-orange-500 font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200">
                            View Menus
                          </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent>
                          <DropdownMenuItem onClick={() => navigate(`/restaurant/${restaurant._id}`)}>
                            View Direct Menu
                          </DropdownMenuItem>
      ...
      <Dialog open={isQRDialogOpen} onOpenChange={setIsQRDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>QR Code for {selectedRestaurant?.restaurantName}</DialogTitle>
            <DialogDescription>
              Scan this QR code to view the menu on your mobile device.
            </DialogDescription>
          </DialogHeader>
          {selectedRestaurant && (
            <div className="flex flex-col items-center gap-4">
              <QRCode value={`${window.location.origin}/restaurant/${selectedRestaurant._id}`} />
              <Button onClick={() => {
